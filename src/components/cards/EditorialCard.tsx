    ...
    >
      <Link href={`/products/${category.slug}`} className="focus-ring block h-full">
        ...
        <motion.div
          ...
          className={cn("absolute inset-x-0 bottom-0", compact ? "p-4 md:p-5" : "p-6 md:p-8")}
        >
          <div className="flex items-end justify-between gap-3">
            <div className="min-w-0">
              ...
              <h3
                className={cn(
                  "font-heading leading-tight text-ivory-50",
                  compact ? "text-sm md:text-base" : "mt-2 text-2xl md:text-3xl"
                )}
              >
                {category.title}
              </h3>
            ...
            <motion.span
              ...
              className={cn(
                "flex shrink-0 items-center justify-center rounded-full border border-ivory-100/30 text-ivory-50",
