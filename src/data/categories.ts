...
export const categories: Category[] = [
  {
    ...
    seo: {
      ...
      description:
        "Explore premium plywood, laminates, wooden mouldings, boards, and flush doors from trusted brands.",
      keywords: ["plywood", "laminates", "wooden boards", "flush doors"],
    },
  },
  {
    id: "c2",
    ...
    seo: {
      ...
      description:
        "Shop moisture-proof PVC panels, WPC louvers, fluted panels, UV sheets, and ACP cladding.",
      keywords: ["pvc panels", "wpc louvers", "fluted panels", "acp sheets"],
    },
  },
  {
    id: "c3",
    ...
    seo: {
      ...
      description:
        "Browse pull-out baskets, magic corners, sinks, chimneys, and modular kitchen hardware.",
      keywords: ["modular kitchen accessories", "kitchen hardware", "pull out basket"],
    },
  },
  {
    id: "c4",
    ...
    seo: {
      ...
      description:
        "Shop premium hinges, handles, locks, sliding channels, and railing hardware for interiors.",
      keywords: ["door hinges", "cabinet handles", "locks", "sliding channels"],
    },
  },
  {
    id: "c5",
    slug: "wooden-adhesive",
    title: "Wooden Adhesive",
    icon: "Droplets",
    ...
    seo: {
      ...
      description:
        "Explore industrial-grade wood adhesives, sealants, and bonding solutions from trusted brands.",
      keywords: ["fevicol", "wood adhesive", "silicon sealant"],
    },
  },
  {
    id: "c6",
    ...
    seo: {
      ...
      description:
        "Custom manufacturing of modular kitchens, wardrobes, and wooden or PVC temple units.",
      keywords: ["modular kitchen manufacturer", "wardrobe manufacturer"],
    },
  },
  {
    id: "c7",
    slug: "cnc-machine-work",
    ...
    seo: {
      ...
      description:
        "Precision CNC cutting services for HDHMR doors, jali, 3D/2D doors, and wall design panels.",
      keywords: ["cnc machine work", "3d doors", "hdhmr doors", "jali design"],
    },
  },
  {
    id: "c8",
    ...
    seo: {
      ...
      description:
        "Shop fluted glass, toughened glass, lacquer glass, colour glass, and LED mirrors.",
      keywords: ["fluted glass", "toughened glass", "led mirror", "lacquer glass"],
    },
  },
  {
    id: "c9",
    ...
    seo: {
      ...
      description:
        "Artisanal glass etching, beveling, crystal work, and colour work services.",
      keywords: ["glass etching", "beveling", "crystal glass work"],
    },
  },
];
